...
All required files taken from PatcherSupportPkg [v1.9.1](https://github.com/dortania/PatcherSupportPkg/tree/a5f43c1d2481b18a2251ce3fd19b3fee68b5f60d) repo and organized for directly copying from Terminal in one go via looking for necessary patchsets from [here](https://github.com/dortania/OpenCore-Legacy-Patcher/blob/ae8d6923d78f67775f3324dda48fa689897ab87a/resources/sys_patch/sys_patch_generate.py) and getting copied files list and running commands etc. from [here](https://github.com/dortania/OpenCore-Legacy-Patcher/blob/ae8d6923d78f67775f3324dda48fa689897ab87a/data/sys_patch_dict.py) by looking into Open Core Legacy Patcher [v1.4.3](https://github.com/dortania/OpenCore-Legacy-Patcher/tree/ae8d6923d78f67775f3324dda48fa689897ab87a). I copied every necessary files on 18th December 2024. So, possibility of patches being updated likely occur. You can look for these links' up-to-date version if these patches are updated. Just take files listed on [here](https://github.com/eflanili7881/NVIDIAWebDriversForMacOSMojaveAndCatalina/blob/main/patchlist_for_web_drivers.txt) I prepared for you.

These files are here only and only here for archival purposes. If you can, you can download required files listed on [here](https://github.com/eflanili7881/NVIDIAWebDriversForMacOSMojaveAndCatalina/blob/main/patchlist_for_web_drivers.txt) from [PatcherSupportPkg](https://github.com/dortania/PatcherSupportPkg) repo.
