...
All required files taken from [PatcherSupportPkg](https://github.com/dortania/PatcherSupportPkg) repo on 18th December 2024 ([v1.9.1](https://github.com/dortania/PatcherSupportPkg/tree/a5f43c1d2481b18a2251ce3fd19b3fee68b5f60d)) and organized for directly copying from Terminal in one go via looking for necessary patchsets from [here](https://github.com/dortania/OpenCore-Legacy-Patcher/blob/ae8d6923d78f67775f3324dda48fa689897ab87a/resources/sys_patch/sys_patch_generate.py) and getting copied files list and running commands etc. from [here](https://github.com/dortania/OpenCore-Legacy-Patcher/blob/ae8d6923d78f67775f3324dda48fa689897ab87a/data/sys_patch_dict.py). Took these links from Open Core Legacy Patcher [v1.4.3](https://github.com/dortania/OpenCore-Legacy-Patcher/tree/ae8d6923d78f67775f3324dda48fa689897ab87a). You can go there if the patches are updated. Just take files listed on [here](https://github.com/eflanili7881/NVIDIAWebDriversForMacOSMojaveAndCatalina/blob/main/patchlist_for_web_drivers.txt).
